...
### 25. What is SynFutures' BTC Hash Rate（BTCHASH）Futures? Is it a cloud mining token?
...
### 26. What does 1 long position of BTCHASH represent? What is being "longed"?
...
### 27. When would a trader gain profit or suffer from loss? How are the Profit and Loss ("PnL”) settled?
...
### 29. Bob is a miner who wants to lock in return and hedge against change in mining difficulty. How can he use the Hash Rate Futures?
Assuming 
...
### 30. Bob wants to arbitrage between mining power and Hash Rate Futures. How can he do it?
Assuming
- Hash Rate Futures contract maturing on 1 May 2021 is trading at `P1 = 0.0823 BTC` and contract maturing on 14 May 2021 at `P2 = 0.0812 BTC`
- Cloud mining power of 1 PH/s for 1 to 28 May 2021 including electricity is offered at `R = 0.1605 BTC`
...
### 31. Bob has a strong view on the direction of the future mining difficulty changes. How can he trade on it?
...
### 32. Historically Bitcoin mining difficulty has been trending up. Would everyone short the futures contract to long difficulty? When should someone long the futures to short difficulty?
...
### 33. How do I hedge against changes in mining difficulty for a period longer than 14 days?
...
### 34. Why can I only choose certain dates or block height on the App as maturity?
...
### 35. As difficulty resetting time is uncertain, why can I see a calendar date as a maturity date, corresponding to the difficulty resetting date on the app?
...
### 36. Why is there a spot difficulty index in the design? Isn't BTC mining difficulty a fixed value and being updated every two weeks?
...
### 37. How often does spot difficulty index get updated?
...
### 38. What is mark price used for?
Similar to our asset futures, Hash Rate Futures uses mark price to mark to market all traders' positions, and thus determines whether a trader’s position should be liquidated.

### 39. What is the exact definition of the underlying for one BTCHASH futures contract?
...
### 40. Is the mining difficulty oracle for BTCHASH centralized? Can it be manipulated by the SynFutures Team?
