...
### 29. Why can I only choose certain dates or block height on the App as maturity?
...
### 30. As difficulty resetting time is uncertain, why can I see a calendar date as a maturity date, corresponding to the difficulty resetting date on the app?
...
### 31. Why is there a spot difficulty index in the design? Isn't BTC mining difficulty a fixed value and being updated every two weeks?
...
### 35. Historically Bitcoin mining difficulty has a trend going up. Would everyone short the futures contract to long difficulty? When should someone long the futures to short difficulty?
...
### 36. When would a trader gain profit or suffer from loss? How are the Profit and Loss (“PnL”) settled?
...
### 38. How do I hedge against changes in mining difficulty for a period longer than 14 days?
...
#
***For simplicity, below examples ignore the transaction fees and edge cases where mining could be interrupted due to accidents.***
### 39. Bob is a miner who wants to lock in return and hedge against change in mining difficulty. How can he use the Hash Rate Futures?
Assuming 
...
### 40. Bob wants to arbitrage between mining power and Hash Rate Futures. How can he do it?
Assuming
...
### 41. Bob has a strong view on the direction of the future mining difficulty changes. How can he trade on it?
